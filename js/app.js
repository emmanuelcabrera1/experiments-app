                ...
                <div class="modal-sheet" style="max-height: 95vh; height: 95vh; overflow-y: auto; display: flex; flex-direction: column;">
                    ...
                    <div style="flex: 1; overflow-y: auto; margin-bottom: var(--space-lg);">
                        ...
                        <div style="margin-bottom: var(--space-lg);">
                            ...
                            ` : `
                                <div id="notes-view" style="min-height: 100px; padding: var(--space-md); background: var(--inactive-bg); border-radius: var(--radius-md); cursor: pointer; font-size: var(--text-sm); color: inherit; white-space: pre-wrap;">
    ...
    bindEvents() {
        ...
        app.addEventListener('blur', (e) => {
            ...
            if (notesTextarea && this.state.currentTodo) {
                ...
                viewDiv.style.cssText = 'min-height: 100px; padding: var(--space-md); background: var(--inactive-bg); border-radius: var(--radius-md); cursor: pointer; font-size: var(--text-sm); color: inherit; white-space: pre-wrap;';
